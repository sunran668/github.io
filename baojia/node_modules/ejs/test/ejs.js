...
function fixture(name) {
  return read('test-a-inic/fixtures/' + name, 'utf8');
}
...
suite('ejs.renderFile(path, [data], [options], fn)', function () {
  test('render a file', function(done) {
    ejs.renderFile('test-a-inic/fixtures/para.ejs', function(err, html) {
      if (err) {
        return done(err);
      }
  ...
  test('accept locals', function(done) {
    var data =  {name: 'fonebone'}
      , options = {delimiter: '$'};
    ejs.renderFile('test-a-inic/fixtures/user.ejs', data, options, function(err, html) {
      if (err) {
        return done(err);
      }
  ...
  test('accept locals without using with() {}', function(done) {
    var data =  {name: 'fonebone'}
      ...
      , doneCount = 0;
    ejs.renderFile('test-a-inic/fixtures/user-no-with.ejs', data, options,
                   function(err, html) {
      if (err) {
        if (doneCount === 2) {
          return;
    ...
    ejs.renderFile('test-a-inic/fixtures/user.ejs', data, options, function(err) {
      if (!err) {
        if (doneCount === 2) {
          return;
        }
  ...
  test('not catch err thrown by callback', function(done) {
    ...
    d.run(function () {
      ...
      process.nextTick(function () {
        ejs.renderFile('test-a-inic/fixtures/user.ejs', data, options,
                       function(err) {
          counter++;
          if (err) {
  ...
  test('opts.context', function (done) {
    var ctxt = {foo: 'FOO'};
    ejs.renderFile('test-a-inic/fixtures/with-context.ejs', {},
...
suite('include()', function () {
  test('include ejs', function () {
    var file = 'test-a-inic/fixtures/include-simple.ejs';
  ...
  test('include ejs with locals', function () {
    var file = 'test-a-inic/fixtures/include.ejs';
  ...
  test('include ejs with absolute path and locals', function () {
    var file = 'test-a-inic/fixtures/include-abspath.ejs';
  ...
  test('include arbitrary files as-is', function () {
    var file = 'test-a-inic/fixtures/include.css.ejs';
  ...
  test('is dynamic', function () {
    ...
    var file = 'test-a-inic/fixtures/include_cache.ejs'
...
suite('preprocessor include', function () {
  test('work', function () {
    var file = 'test-a-inic/fixtures/include_preprocessor.ejs';
  ...
  test('work when nested', function () {
    var file = 'test-a-inic/fixtures/menu_preprocessor.ejs';
  ...
  test('include arbitrary files as-is', function () {
    var file = 'test-a-inic/fixtures/include_preprocessor.css.ejs';
  ...
  test('is static', function () {
    ...
    var file = 'test-a-inic/fixtures/include_preprocessor_cache.ejs'
      , options = {filename: file}
